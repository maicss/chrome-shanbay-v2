...
const addTends = () => {
  ...
  document.querySelector('div.header ul[role=navigation]').insertAdjacentHTML('beforeEnd', '<li><a class="js-selected-navigation-item header-navlink" href="/trending">trending</a></li>')
}
/**
 * GitHub 动态首页添加头像
